      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        <?php $__currentLoopData = $recipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="max-w-xs xl:max-w-sm mx-auto my-2.5 rounded overflow-hidden
              shadow-lg">
            <img class="w-full" src="<?php echo e(asset('storage/'. $recipe->image)); ?>"
                 alt="">
            <div class="px-6 py-4">
...
<?php /**PATH /home/hussain-fedora/code/recipewizard-boilerplate/resources/views/livewire/user-recipes-list.blade.php ENDPATH**/ ?>